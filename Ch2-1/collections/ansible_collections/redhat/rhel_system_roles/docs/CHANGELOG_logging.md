...
- Fix yamllint errors.
- Instead of having four symlinks in tests/roles/rhel-system-roles.logging, changing tests/roles/rhel-system-roles.logging itself a symlink as most system roles do.
