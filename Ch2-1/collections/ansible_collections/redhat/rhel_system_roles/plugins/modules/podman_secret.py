...
EXAMPLES = r"""
- name: Create secret
  redhat.rhel_system_roles.podman_secret:
    state: present
    name: mysecret
...
from ansible_collections.redhat.rhel_system_roles.plugins.module_utils.podman_lsr.podman.common import LooseVersion
from ansible_collections.redhat.rhel_system_roles.plugins.module_utils.podman_lsr.podman.common import get_podman_version
