...
EXAMPLES = r"""
- name: Pull an image
  redhat.rhel_system_roles.podman_image:
...
from ansible_collections.redhat.rhel_system_roles.plugins.module_utils.podman_lsr.podman.common import run_podman_command
from ansible_collections.redhat.rhel_system_roles.plugins.module_utils.podman_lsr.podman.quadlet import create_quadlet_state
